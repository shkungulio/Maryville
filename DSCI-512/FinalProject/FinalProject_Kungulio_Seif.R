...
##  1.  Data Preparation.                                                      #
################################################################################
##    1.a.  Load the dataset insurance.csv into memory.


##    1.b.  In the data frame, transform the variable charges by setting 
##          insurance$charges = log(insurance$charges). Do not transform it 
##          outside of the data frame.


##    1.c.  Using the data set from 1.b, use the model.matrix() function to 
...
##    1.d.  Use the sample() function with set.seed equal to 1 to generate 
...
##    1.e.  Create a training and test data set from the data set created 
...
##    1.f.  Create a training and test data set from data set created in 
...
################################################################################
##    2.a.  Perform multiple linear regression with charges as the response and 
...
##    2.c.  Does sex have a statistically significant relationship to the 
##          response?


##    2.d.  Perform best subset selection using the stepAIC() function from 
##          the MASS library, choose best model based on AIC. For the "direction"
##          parameter in the stepAIC() method, set direciton="backward"


##    2.e.  Compute the test error of the best model in #3d based on AIC using 
##          LOOCV using trainControl() and train() from the caret library. 
##          Report the MSE by squaring the reported RMSE.


##    2.f.  Calculate the test error of the best model in #3d based on AIC 
...
##    2.g.  Calculate and report the test MSE using the best model from 2.d 
##          and test data set created in step 1.e.


##    2.h.  Compare the test MSE calculated in step 2.f using 10-fold 

...
print(dupes)
```
The dataset contains 35,575 duplicate rows across 22 health-related variables, including indicators like diabetes, BMI, smoking, and cholesterol status. These duplicates can distort analysis and bias model results if not addressed. It is recommended to review and remove duplicates to ensure accurate and reliable insights.
